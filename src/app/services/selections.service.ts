...
export class SelectionsService {
  ...
  pickupLocationArray: string[] = [
    ...
    'Beer Sheva BEVC01',
    'Beit Shemesh JRSN01',
    'Bnei Brak Kahanman 106 TLVS01',
    'Bnei Brak Mivtza',
    'Kadesh TLVE01',
    'Elad',
    'Eilat ETHC01',
    'Eilat Ramon International Airport ETMT01',
    'Haifa HFAC01',
    'Herzliya TLVN01',
    'Jerusalem King David JRSC01',
    'Jerusalem Romema',
    'Jerusalem Talpiyot',
    'Kfar Saba TLVN02',
    'Kiryat Shmone  KSWC01',
    'Petah Tikva TLVE02',
    'Nes Tziona TLVS04',
    'Netanya TLVN03',
    'Netivot',
    'Rehovot TLVS05',
    'Rishon LeZion TLVS03',
    'Tel Aviv  Hamelacha TLVC01',
    'Tel Aviv Ben Gurion International Airport TLVT03',
    'Tel Aviv Hayarkon',
    'Tiberias HFAE01'];
